...
local theme = {
  ...
  insert = { a = { fg = colors.black, bg = colors.blue, gui = 'bold' } ,
    ...
    z = { fg = colors.black, bg = colors.blue, gui = 'none' },
  },
  visual = { a = { fg = colors.black, bg = colors.green, gui = 'bold' } ,
    b = { fg = colors.black, bg = colors.cyan },
    x = { fg = colors.white },
    y = { fg = colors.foreground, bg = colors.black4 },
    z = { fg = colors.black, bg = colors.green, gui = 'none' },
  },
  replace = { a = { fg = colors.black, bg = colors.yellow, gui = 'bold' } ,
    b = { fg = colors.black, bg = colors.cyan },
    x = { fg = colors.white },
    y = { fg = colors.foreground, bg = colors.black4 },
    z = { fg = colors.black, bg = colors.yellow, gui = 'none' },
  },
  command = { a = { fg = colors.black, bg = colors.magenta, gui = 'bold' } ,
    b = { fg = colors.black, bg = colors.cyan },
    x = { fg = colors.white },
    y = { fg = colors.foreground, bg = colors.black4 },
    z = { fg = colors.black, bg = colors.magenta , gui = 'none' },
  },
